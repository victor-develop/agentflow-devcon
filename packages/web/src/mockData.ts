...
export const mockContracts: ApiContract[] = [
  ...
  { id: 'API-012', protocol: 'rest', method: 'POST', endpoint: '/api/v1/routing/simulate', description: 'Simulate routing for a notification payload', status: 'draft', storyId: 'STORY-006' },
  { id: 'API-013', protocol: 'rest', method: 'GET', endpoint: '/api/v1/routing/rules/:id/versions', description: 'Get version history for a rule', status: 'draft', storyId: 'STORY-007' },
  { id: 'API-014', protocol: 'rest', method: 'POST', endpoint: '/api/v1/routing/rules/:id/rollback', description: 'Rollback a rule to a previous version', status: 'draft', storyId: 'STORY-007' },
  { id: 'API-015', protocol: 'rest', method: 'GET', endpoint: '/api/v1/analytics/delivery', description: 'Delivery analytics summary', status: 'agreed', storyId: 'STORY-008' },
  { id: 'API-016', protocol: 'rest', method: 'GET', endpoint: '/api/v1/analytics/channels', description: 'Per-channel delivery metrics', status: 'draft', storyId: 'STORY-009' },
  { id: 'API-017', protocol: 'rest', method: 'GET', endpoint: '/api/v1/analytics/engagement', description: 'User engagement heatmap data', status: 'draft', storyId: 'STORY-010' },
  { id: 'API-018', protocol: 'rest', method: 'POST', endpoint: '/api/v1/analytics/export', description: 'Export analytics report (CSV/PDF)', status: 'draft', storyId: 'STORY-011' },
  { id: 'API-019', protocol: 'rest', method: 'POST', endpoint: '/api/v1/notifications/batch', description: 'Submit notification batch', status: 'draft', storyId: 'STORY-012' },
  { id: 'API-020', protocol: 'rest', method: 'GET', endpoint: '/api/v1/dedup/rules', description: 'List deduplication rules', status: 'draft', storyId: 'STORY-013' },
  { id: 'API-021', protocol: 'rest', method: 'GET', endpoint: '/api/v1/admin/workspaces', description: 'List workspaces', status: 'draft', storyId: 'STORY-015' },
  { id: 'API-022', protocol: 'rest', method: 'GET', endpoint: '/api/v1/admin/users', description: 'List workspace users', status: 'draft', storyId: 'STORY-016' },
  { id: 'API-023', protocol: 'rest', method: 'GET', endpoint: '/api/v1/admin/audit', description: 'Fetch audit log entries', status: 'draft', storyId: 'STORY-017' },
  { id: 'API-024', protocol: 'rest', method: 'POST', endpoint: '/api/v1/integrations/slack/auth', description: 'Initiate Slack OAuth', status: 'agreed', storyId: 'STORY-018' },
  { id: 'API-025', protocol: 'rest', method: 'POST', endpoint: '/api/v1/integrations/webhook', description: 'Register outbound webhook', status: 'agreed', storyId: 'STORY-019' },
  { id: 'API-026', protocol: 'rest', method: 'POST', endpoint: '/api/v1/integrations/pagerduty', description: 'Configure PagerDuty integration', status: 'draft', storyId: 'STORY-020' },
  { id: 'API-027', protocol: 'rest', method: 'POST', endpoint: '/api/v1/integrations/teams', description: 'Configure Teams connector', status: 'draft', storyId: 'STORY-021' },
